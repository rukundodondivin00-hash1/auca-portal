              ...
              <CardContent>
                <form onSubmit={handleSaveProfile} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Work Email</label>
                      <input 
                        type="email" 
                        value={email}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Work Phone</label>
                      <input 
                        type="tel" 
                        value={phone}
              ...
              <CardContent>
                <div className="space-y-6">
                  <div className="space-y-4">
                    <h3 className="text-sm font-bold text-gray-900 dark:text-slate-300 uppercase tracking-wider">Contract Events</h3>
                    
                    <div className="flex items-start justify-between">
                      <div className="pr-4">
                        <p className="font-medium text-gray-800 dark:text-slate-200">New Contracts</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="pr-4">
                        <p className="font-medium text-gray-800 dark:text-slate-200">Late Payments & Penalties</p>
                  ...
                  <div className="space-y-4 pt-6 border-t dark:border-slate-800">
                    <h3 className="text-sm font-bold text-gray-900 dark:text-slate-300 uppercase tracking-wider">System Alerts</h3>
                    
                    <div className="flex items-start justify-between">
                      <div className="pr-4">
                        <p className="font-medium text-gray-800 dark:text-slate-200">Term Registration Status</p>
